...
export default function VisionSection() {
  return (
    <section
      className={`${fraunces.variable} ${inter.variable} relative overflow-hidden bg-brand-primary px-6 py-28 font-[family-name:var(--font-body)] lg:px-10`}
    >
      {/* Vision & Mission */}
      <div className="mt-10 max-w-xl rounded-2xl bg-brand-primary p-8">
        <div className="space-y-6">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-accent">
              Vision
            </p>
            <p className="mt-2 text-base leading-7 text-brand-cream/90">
